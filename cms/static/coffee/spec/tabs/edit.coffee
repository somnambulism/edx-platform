describe "TabsEditingDescriptor", ->
  beforeEach ->
    ...
    TabsEditingDescriptorModel.addModelUpdate(@html_id, 'Tab 0 Editor', @tab_0_modelUpdate)
    TabsEditingDescriptorModel.addOnSwitch(@html_id, 'Tab 0 Editor', @tab_0_switch)
    TabsEditingDescriptorModel.addModelUpdate(@html_id, 'Tab 1 Transcripts', @tab_1_modelUpdate)
